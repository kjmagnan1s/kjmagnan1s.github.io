...
```{r text mining searches, fig.align="center"}
...
```{r wordcloud 2, fig.align="center"}
...
Now, ironically, this second wordcloud, specific for the September 2017 spike we found, does not really offer any insights into why there were so many searches. That's unfortunate but I have a few other ideas to try and pull out some more insights into this particular time period. 
